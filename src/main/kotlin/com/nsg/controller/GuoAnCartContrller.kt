...
@Api(basePath = "/v1/mall/guoan", value = "guoancart", description = "国安购物车API", produces = "application/json", position = 4)
@RestController
@RequestMapping("/v1/mall/guoan")
class GuoAnCartContrller
@Autowired constructor(
    ...
    private val LOGGER = LoggerFactory.getLogger(GuoAnCartContrller::class.java)
...
//            LOGGER.info("-------此单原邮费(分):$shippingFee,测试邮费:1")
//
//            //测试邮费
//            shippingFee = 1

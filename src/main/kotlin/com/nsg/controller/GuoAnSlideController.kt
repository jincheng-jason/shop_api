...
@Api(basePath = "/v1/mall/guoan", value = "guoanslide", description = "国安跑马灯API", produces = "application/json", position = 7)
@RestController
@RequestMapping("/v1/mall/guoan")
class GuoAnSlideController @Autowired constructor(
        var imageService: ImageService
) {

    val shopId = ShopIds.GUOAN.shopId
    private val LOGGER = LoggerFactory.getLogger(GuoAnSlideController::class.java)
